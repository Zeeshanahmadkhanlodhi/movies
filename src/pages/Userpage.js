...
const Userpage = () => {
  ...
  // if (history.location.state?.noRefresh) {
  // } else history.push("/", { id: match.params.id, name: match.params.name });

  useEffect(() => {
    //if (history.location.state?.noRefresh) {
    console.log("askldnaskdsfajdnsad", history.location.state);
    ...
    if (!pageNumber) {
      ...
      db.child("user")
        ...
        .on("value", (snapshot) => {
          if (snapshot.exists()) {
            console.log("user post data", snapshot.val());
    ...
    // } else {
    //   console.log("askldnaskdsfajdnsad");
    //   history.push("/", { id: match.params.id, name: match.params.name });
    // }
